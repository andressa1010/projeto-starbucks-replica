...
const CappucinoSemAcucar = () => {
    return ( 
        <>
        <Home/>
        <img className="logo-star"
         src="/01_d_cc_latte_nas.webp" alt="imagem"></img>
    ...
    <h2>GAMA STARBUCKS® CHILLED CLASSICS
        Refresh and Reset com outro sabor</h2>
...
export default CappucinoSemAcucar;